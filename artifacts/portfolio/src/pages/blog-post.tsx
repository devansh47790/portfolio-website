...
export default function BlogPostPage() {
  ...
  return (
    <PageTransition>
      <SEO title={`${post.title} | Web Dev Insights`} description={post.excerpt} type="article" />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-4 text-sm text-muted-foreground font-mono mb-6">
              <span className="flex items-center bg-card px-3 py-1 border border-border">
          ...
          <div className="bg-card border border-border p-8 flex flex-col sm:flex-row items-center gap-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                I build fast, modern websites for businesses that want results. If
                your site isn't pulling its weight, let's talk.
              </p>
