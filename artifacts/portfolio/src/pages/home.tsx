...
import { ArrowRight, Code2, MonitorSmartphone, Terminal } from "lucide-react";
import { Link } from "wouter";

import { getFeaturedProjects, type Project } from "@/lib/api/projects";
import { type Service } from "@/data/services";
import { getFeaturedServices, getServices } from "@/lib/api/services";
  ...
  useEffect(() => {
    async function loadServices() {
      try {
        ...
        setServices(data.length > 0 ? data : await getServices());
      } catch (err) {
    ...
    async function loadFeatured() {
      try {
        ...
        setFeaturedError(
          err instanceof Error ? err.message : "Failed to load featured projects."
        );
      } finally {
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl leading-relaxed">
              I&apos;m a freelance web developer based in Melbourne. I partner with small
              businesses and brands who need someone reliable, technical, and
              communication-friendly to build fast, SEO-optimised websites.
            </p>
      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground">
                A well-built website isn&apos;t just about looking good - it should load
                fast, rank well, and convert visitors into leads. I focus on the
                technical foundations that drive real business results.
              </p>
            </div>
            <Link
              href="/services"
              className="inline-flex items-center text-accent hover:text-foreground transition-colors font-medium"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {servicesError && (
              <p className="text-sm text-muted-foreground md:col-span-3">{servicesError}</p>
            )}
            {!servicesError &&
              services.slice(0, 3).map((service, index) => (
                <div
                  key={service.id}
                  className="group p-8 rounded-none border border-border bg-card hover:border-accent/50 transition-all duration-300"
                >
      ...
      <section className="py-24 md:py-32 bg-card/30 border-y border-border/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {loadingFeatured && <p>Loading projects...</p>}
      ...
      <section className="py-24 md:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-lg text-muted-foreground">
              A transparent, predictable process designed to eliminate surprises and
              deliver exactly what was promised.
            </p>
          </div>

          <div className="relative">
            <div className="absolute top-1/2 left-0 w-full h-px bg-border hidden lg:block -translate-y-1/2" />

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-4 relative z-10">
              {[
                {
                  title: "Discovery",
                  desc: "Understanding your goals, audience, and technical needs.",
                },
                {
                  title: "Design & Plan",
                  desc: "Mapping the structure, wireframes, and tech stack.",
                },
                {
                  title: "Development",
                  desc: "Writing clean, performant code with regular updates.",
                },
                {
                  title: "Review & Test",
                ...
                },
                {
                  ...
                  desc: "Deployment, training, and ongoing maintenance.",
                },
              ].map((step, index) => (
                <div
                  key={index}
                  className="relative bg-background p-6 border border-border rounded-none shadow-sm hover:border-accent/50 transition-colors"
                >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "The attention to detail and technical execution was flawless. Our new site is significantly faster and conversion rates are up 40% since launch.",
                name: "Sarah Jenkins",
                role: "Marketing Director",
              },
              {
                quote:
                  "Finally, a developer who communicates clearly, hits deadlines, and actually understands SEO. The whole process was completely frictionless.",
                name: "David Chen",
                role: "Founder, local SME",
              },
              {
                quote:
                  "We needed a complex custom booking flow built into our WordPress site. It was delivered on time, perfectly matching the design specs, and works flawlessly.",
                name: "Emma Robertson",
              ...
              <div
                key={index}
                className="p-8 border border-border bg-background flex flex-col justify-between"
              >
                <div className="mb-8">
      ...
      <section className="py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center">
          ...
          <p className="text-xl text-muted-foreground mb-12">
            Whether you have a detailed brief or just an idea, let&apos;s discuss how
            we can elevate your digital presence.
          </p>
          <Link
            href="/contact"
